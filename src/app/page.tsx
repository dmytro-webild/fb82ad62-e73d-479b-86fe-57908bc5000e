...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        { src: "http://img.b2bpic.net/free-vector/futuristic-infographic-template_23-2148446452.jpg", alt: "user avatar 1" },
        { src: "http://img.b2bpic.net/free-vector/futuristic-textbox-callout-titles-scifi-tech-borders-hud-frames_88138-1008.jpg", alt: "user avatar 2" },
        { src: "http://img.b2bpic.net/free-vector/blue-technological-background_1406-11.jpg", alt: "user avatar 3" },
        { src: "http://img.b2bpic.net/free-vector/futuristic-digital-user-interface-dashboard_53876-115874.jpg", alt: "user avatar 4" },
        { src: "http://img.b2bpic.net/free-photo/eye-icon-front-side_187299-45825.jpg", alt: "user avatar 5" }
      ]}
      marqueeItems={[
        { type: "text", text: "Level Up Your Life" },
        { type: "text", text: "Daily XP Tracking" },
        { type: "text", text: "Elite Leaderboards" },
        { type: "text", text: "System Rewards" },
  ...
  <div id="about" data-section="about">
      ...
      buttons={[{ text: "Learn the System", href: "#" }]}
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      useInvertedBackground={true}
      metrics={[
        { id: "m1", value: "100", title: "Max Level", description: "Reach the pinnacle of human potential.", imageSrc: "http://img.b2bpic.net/free-vector/video-game-elements-collection_23-2150268286.jpg" },
        { id: "m2", value: "500k+", title: "Active Players", description: "Players currently in the system.", imageSrc: "http://img.b2bpic.net/free-photo/digital-led-scoreboard-display_187299-47140.jpg" },
        { id: "m3", value: "94%", title: "Daily Completion", description: "Rate of quest success.", imageSrc: "http://img.b2bpic.net/free-photo/variety-people-multitasking-3d-cartoon-scene_23-2151294543.jpg" }
      ]}
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        {
          id: "free",          badge: "Base Class",          price: "$0",          subtitle: "For early awakeners",          features: ["Daily Quests", "Basic Stats"],
          buttons: [{ text: "Free", href: "#" }]
        },
        {
          id: "premium",          badge: "S-Rank Status",          price: "$9.99",          subtitle: "For power-levelers",          features: ["Double XP Bonus", "Elite Leaderboards", "Ad-free Experience"],
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "1", title: "What happens if I miss a quest?", content: "You will suffer a penalty in your XP progression and character status." },
        { id: "2", title: "How do I level up?", content: "By consistently completing your daily tasks and meeting guild targets." },
        { id: "3", title: "What is premium?", content: "Premium status provides double XP, custom skins, and advanced analytics." }
      ]}
  ...
  <div id="footer" data-section="footer">
      <FooterLogoEmphasis
      columns={[
        { items: [{ label: "System", href: "#" }, { label: "Support", href: "#" }] },
